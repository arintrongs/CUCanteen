...
var shop_rating = function(data) {
	...
	dcfr.append('<div class="row"><div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><div class="container-fluid"><div class="ratings"><div class="empty-stars"></div><div class="full-stars" style="width:'+ data.rating/5*100 +'%;"></div></div></div><br>'+'<h4>'+data.rating+'</h4><br></div></div>' );
	return dcfr;
}
