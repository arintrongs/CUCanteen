...
var shop_rating = function(data) {
	...
	dcfr.append('<div class="row"><div class="col-lg-2"></div><div class="col-lg-8"><div class="star-ratings-css"><div class="star-ratings-css-top" style="width: '+data.rating/5*125+'%"><span>★</span><span>★</span><span>★</span><span>★</span><span>★</span></div><div class="star-ratings-css-bottom"><span>★</span><span>★</span><span>★</span><span>★</span><span>★</span></div></div><br>'+'<h4>'+data.rating+'</h4><br></div><div class="col-lg-2"></div></div>' );
	return dcfr;
}
